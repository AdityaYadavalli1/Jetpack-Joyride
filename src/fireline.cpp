...
Firebeam::Firebeam(float x, float y, color_t color) {
    ...
    static const GLfloat middle_buffer_data[] = {
        ...
        //  0.5, -0.5, 0.5,
        // -0.5,  0.5, 0.5,
        //  0.5, -0.5, 0.5,//2nd triangle
        // -0.5,  0.5, 0.5,
        // -0.5, -0.5, 0.5,
        // 4.0,  1.0,  0.0,
        // 4.0, -1.0,  0.0,
        // 5.0,  1.0,  0.0, // right dumbel1
        // 5.0,  1.0,  0.0,
        // 4.0, -1.0,  0.0,
        // 5.0, -1.0,  0.0, // right dumbel2
           // -1.0,  1.0,  0.0,
           // -1.0, -1.0,  0.0,
...
void Firebeam::draw(glm::mat4 VP) {
    ...
    glm::mat4 scale = glm::scale(glm::vec3(0.8f, 0.8f ,0.8f));  // glTranslatef
